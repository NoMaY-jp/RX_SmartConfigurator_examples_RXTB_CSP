...
#pragma interrupt r_Config_SCI8_transmit_interrupt(vect=VECT(SCI8,TXI8),fint)
#else
#pragma interrupt r_Config_SCI8_transmit_interrupt(vect=VECT(SCI8,TXI8))
#endif
static void r_Config_SCI8_transmit_interrupt(void)
{
...
#if FAST_INTERRUPT_VECTOR == VECT_SCI8_TEI8
#pragma interrupt r_Config_SCI8_transmitend_interrupt(vect=VECT(SCI8,TEI8),fint)
#else
#pragma interrupt r_Config_SCI8_transmitend_interrupt(vect=VECT(SCI8,TEI8))
#endif
static void r_Config_SCI8_transmitend_interrupt(void)
{
    /* Set TXD8 pin */
...
#pragma interrupt r_Config_SCI8_receive_interrupt(vect=VECT(SCI8,RXI8),fint)
#else
#pragma interrupt r_Config_SCI8_receive_interrupt(vect=VECT(SCI8,RXI8))
#endif
static void r_Config_SCI8_receive_interrupt(void)
{
