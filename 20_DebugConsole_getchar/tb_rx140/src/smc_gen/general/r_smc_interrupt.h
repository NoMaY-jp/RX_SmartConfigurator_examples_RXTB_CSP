...
#define ICU_AES_AESWRI_PRIORITY                    (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_AES_AESRDI_PRIORITY                    (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_TRNG_TRNGRDI_PRIORITY                  (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_SCI9_ERI9_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_SCI9_RXI9_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_SCI9_TXI9_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_SCI9_TEI9_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
