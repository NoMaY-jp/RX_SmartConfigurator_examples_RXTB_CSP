...
#define ICU_USB1_D0FIFO1_PRIORITY                  (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_USB1_D1FIFO1_PRIORITY                  (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_VBATT_TAMPDI_PRIORITY                  (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_RIICHS0_RXI_PRIORITY                   (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_RIICHS0_TXI_PRIORITY                   (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_USB1_USBI1_PRIORITY                    (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_RSPI1_SPCI1_PRIORITY                   (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_RSPI2_SPCI2_PRIORITY                   (_0F_ICU_PRIORITY_LEVEL15)
