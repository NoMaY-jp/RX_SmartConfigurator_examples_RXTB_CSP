...
void R_Config_SCI5_Create(void)
{
    ...
    PORTA.ODR0.BYTE |= 0x40U;
    PORTA.PMR.BYTE |= 0x08U;

    /* Set SSDA5 pin */
    MPC.PA4PFS.BYTE = 0x0AU;
    PORTA.ODR1.BYTE |= 0x01U;
    ...
    SCI5.SMR.BYTE = _01_SCI_CLOCK_PCLK_4 | _00_SCI_ASYNCHRONOUS_OR_I2C_MODE;
...
*                tx_buf -
*                    transfer buffer pointer (Not used when receive data handled by DTC)
*                tx_num -
