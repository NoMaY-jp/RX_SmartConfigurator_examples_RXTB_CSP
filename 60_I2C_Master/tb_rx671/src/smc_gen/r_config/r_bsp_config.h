...
/* NOTE:
   The default settings are the same as when using RSKRX671.
...
/* Select the source of the sub-clock provided to each module in the backup domain and the remote-control 
   signal receiver.(BKSCCR)
   0 = Internal sub-clock oscillator
   1 = External sub-clock oscillator
*/
#define BSP_CFG_BACKUP_DOMAIN_SUB_CLOCK_SOURCE    (0) /* Generated value. Do not edit this manually */
...
/* Select the frequency correction function of the HOCO.
   0 = Disable FLL of the HOCO. (default)
   1 = Enable FLL of the HOCO.
*/
#define BSP_CFG_HOCO_FLL_ENABLE         (0) /* Generated value. Do not edit this manually */
...
/* Set the frequency trimming value for the HOCO.
   0(Frequency: Low) - 511(Frequency: High)
   Note: The trimming value is adjusted at shipment on the specified conditions and the value after a reset varies 
...
/* Configure whether voltage detection 0 circuit and HOCO are enabled after reset.
   OFS1 - Option Function Select Register 1
       ...
       NOTE: If HOCO oscillation is enabled by OFS1.HOCOEN, HOCO frequency is 16MHz and FLL is disabled.
             BSP_CFG_HOCO_FREQUENCY should be default value and BSP_CFG_HOCO_FLL_ENABLE should be 0.
   Default value is 0xFFFFFFFF.
*/
...
*/
#define BSP_CFG_SWINT_IPR_INITIAL_VALUE     (0xF)
...
*/
#define BSP_CFG_SCI_UART_TERMINAL_CHANNEL        (10)
