...
/* Instant Transmission Enable (ITE) */
#define _00_SCI_INSTANT_TRANSMIT_DISABLE          (0x00U) /* Internal wait time is inserted */
#define _02_SCI_INSTANT_TRANSMIT_ENABLE           (0x02U) /* Data transmission is started immediately */
...
/* Asynchronous Mode Base Clock Select Extended (ABCSE) */
#define _00_SCI_DEPEND_BGDM_ABCS                  (0x00U) /* The number of clock cycles for 1-bit period depends on
                                                             the BGDM and ABCS bits setting. */
#define _08_SCI_6_BASE_CLOCK                      (0x08U) /* Selects 6 base clock cycles for 1-bit period */
...
*/
/* Receiver Input Invert (RINV) */
#define _00_SCI_IN_SIGNAL_NOT_INVERT              (0x00U) /* Does not invert the input signal */
#define _10_SCI_IN_SIGNAL_INVERT                  (0x10U) /* Inverts the input signal */
/* Transmitter Output Invert (TINV) */
#define _00_SCI_OUT_SIGNAL_NOT_INVERT             (0x00U) /* Does not invert the output signal */
#define _20_SCI_OUT_SIGNAL_INVERT                 (0x20U) /* Inverts the output signal */
/* Receive Data Sampling Timing Adjustment (RTADJ) */
#define _00_SCI_RECEIVE_TIME_NOT_ADJUST           (0x00U) /* Does not adjust the sampling point of receive data */
#define _40_SCI_RECEIVE_TIME_ADJUST               (0x40U) /* Adjust the sampling point of receive data */
/* Transmit Signal Transition Timing Adjustment (TTADJ) */
#define _00_SCI_TRANSMIT_TIME_NOT_ADJUST          (0x00U) /* Does not adjust the transition timing of transmit data */
#define _80_SCI_TRANSMIT_TIME_ADJUST              (0x80U) /* Adjust the transition timing of transmit data */
/* SPTR Default Value */
#define _03_SCI_SPTR_DEFAULT                      (0x03U) /* Write default value of SPTR */

/*
    Transmit/Receive Timing Select Register (TMGR)
*/
/* Receive Data Sampling Timing Select (RTMG) */
#define _0F_SCI_SAMPLE_7_CLOCKS_EARLIER           (0x0FU) /* Data are sampled 7 clocks earlier than default point */
#define _0E_SCI_SAMPLE_6_CLOCKS_EARLIER           (0x0EU) /* Data are sampled 6 clocks earlier than default point */
#define _0D_SCI_SAMPLE_5_CLOCKS_EARLIER           (0x0DU) /* Data are sampled 5 clocks earlier than default point */
#define _0C_SCI_SAMPLE_4_CLOCKS_EARLIER           (0x0CU) /* Data are sampled 4 clocks earlier than default point */
#define _0B_SCI_SAMPLE_3_CLOCKS_EARLIER           (0x0BU) /* Data are sampled 3 clocks earlier than default point */
#define _0A_SCI_SAMPLE_2_CLOCKS_EARLIER           (0x0AU) /* Data are sampled 2 clocks earlier than default point */
#define _09_SCI_SAMPLE_1_CLOCK_EARLIER            (0x09U) /* Data are sampled 1 clock earlier than default point */
#define _00_SCI_SAMPLE_DEFAULT_POINT              (0x00U) /* Data are sampled at default point */
#define _01_SCI_SAMPLE_1_CLOCK_LATER              (0x01U) /* Data are sampled 1 clock later than default point */
#define _02_SCI_SAMPLE_2_CLOCKS_LATER             (0x02U) /* Data are sampled 2 clocks later than default point */
#define _03_SCI_SAMPLE_3_CLOCKS_LATER             (0x03U) /* Data are sampled 3 clocks later than default point */
#define _04_SCI_SAMPLE_4_CLOCKS_LATER             (0x04U) /* Data are sampled 4 clocks later than default point */
#define _05_SCI_SAMPLE_5_CLOCKS_LATER             (0x05U) /* Data are sampled 5 clocks later than default point */
#define _06_SCI_SAMPLE_6_CLOCKS_LATER             (0x06U) /* Data are sampled 6 clocks later than default point */
#define _07_SCI_SAMPLE_7_CLOCKS_LATER             (0x07U) /* Data are sampled 7 clocks later than default point */
/* Transmit Signal Transition Timing Select (TTMG) */
#define _F0_SCI_DELAYS_HL_7_CLOCKS                (0xF0U) /* Delays the 1 to 0 transitions for 7 clocks */
#define _E0_SCI_DELAYS_HL_6_CLOCKS                (0xE0U) /* Delays the 1 to 0 transitions for 6 clocks */
#define _D0_SCI_DELAYS_HL_5_CLOCKS                (0xD0U) /* Delays the 1 to 0 transitions for 5 clocks */
#define _C0_SCI_DELAYS_HL_4_CLOCKS                (0xC0U) /* Delays the 1 to 0 transitions for 4 clocks */
#define _B0_SCI_DELAYS_HL_3_CLOCKS                (0xB0U) /* Delays the 1 to 0 transitions for 3 clocks */
#define _A0_SCI_DELAYS_HL_2_CLOCKS                (0xA0U) /* Delays the 1 to 0 transitions for 2 clocks */
#define _90_SCI_DELAYS_HL_1_CLOCK                 (0x90U) /* Delays the 1 to 0 transitions for 1 clock */
#define _00_SCI_WAVEFORM_NOT_CHANGE               (0x00U) /* Does not change the waveform */
#define _10_SCI_DELAYS_LH_1_CLOCK                 (0x10U) /* Delays the 0 to 1 transitions for 1 clock */
#define _20_SCI_SAMPLE_LH_2_CLOCKS                (0x20U) /* Delays the 0 to 1 transitions for 2 clocks */
#define _30_SCI_SAMPLE_LH_3_CLOCKS                (0x30U) /* Delays the 0 to 1 transitions for 3 clocks */
#define _40_SCI_SAMPLE_LH_4_CLOCKS                (0x40U) /* Delays the 0 to 1 transitions for 4 clocks */
#define _50_SCI_SAMPLE_LH_5_CLOCKS                (0x50U) /* Delays the 0 to 1 transitions for 5 clocks */
#define _60_SCI_SAMPLE_LH_6_CLOCKS                (0x60U) /* Delays the 0 to 1 transitions for 6 clocks */
#define _70_SCI_SAMPLE_LH_7_CLOCKS                (0x70U) /* Delays the 0 to 1 transitions for 7 clocks */
