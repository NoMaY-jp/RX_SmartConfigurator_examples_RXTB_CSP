...
void R_Systeminit(void)
{
    ...
    /* Register group AL0 interrupt TEI11 (SCI11) */
    R_BSP_InterruptWrite(BSP_INT_SRC_AL0_SCI11_TEI11,(bsp_int_cb_t)r_Config_SCI11_transmitend_interrupt);
