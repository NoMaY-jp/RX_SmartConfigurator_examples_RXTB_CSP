...
// Note
// 1. This example uses MCU's SCI1 (SSCL1/SSDA1 = Pmod's Pin3/Pin4)
// 2. HS3001 data sheet's I2C command format needs modification of Config_SCI1.c

U_CONFIG_I2C_MASTER_IMPL( SCI1 );
...
int main(void) /* The following code is checked to be built and run */
{
    ...
    for (;;)
    {
        ...
        U_Config_I2C_Master_Send_Ex( SCI1, adr7_HS3001, NULL, 0, MD_WAIT_FINISH );
        ...
        U_Config_I2C_Master_Receive_Ex( SCI1, adr7_HS3001, ret_data, 4, MD_WAIT_FINISH );
