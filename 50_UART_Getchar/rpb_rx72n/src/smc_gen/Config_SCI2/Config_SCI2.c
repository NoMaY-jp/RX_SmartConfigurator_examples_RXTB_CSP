...
void R_Config_SCI2_Create(void)
{
    ...
    SCI2.SMR.BYTE = _00_SCI_CLOCK_PCLK | _00_SCI_MULTI_PROCESSOR_DISABLE | _00_SCI_STOP_1 | _00_SCI_PARITY_DISABLE | 
    ...
    SCI2.SEMR.BYTE = _00_SCI_BIT_MODULATION_DISABLE | _00_SCI_DEPEND_BGDM_ABCS | _10_SCI_8_BASE_CLOCK | 
...
/***********************************************************************************************************************
* Function Name: R_Config_SCI2_Serial_Receive
* Description  : This function receive SCI2data
* Arguments    : rx_buf -
...
MD_STATUS R_Config_SCI2_Serial_Receive(uint8_t * const rx_buf, uint16_t rx_num)
{
