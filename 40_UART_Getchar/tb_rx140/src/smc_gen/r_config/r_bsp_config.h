...
/* Enter the product part number for your MCU. This information will be used to obtain information about your MCU such 
   ...
   | | | |  |  | |___________BSP_CFG_MCU_PART_FUNCTION     = Encryption and CAN included/not included
...
/* Whether Encryption and CAN included or not.
   ...
   A            = 0xA             = Encryption module not included
   B            = 0xB             = Encryption module included
*/
#define BSP_CFG_MCU_PART_FUNCTION   (0xA) /* Generated value. Do not edit this manually */

/* ROM, RAM, and Data Flash Capacity.
   Character(s) = Value for macro = ROM Size/Ram Size/Data Flash Size
   6            = 0x6             = 256KB/64KB/8KB
   5            = 0x5             = 128KB/32KB/8KB
   3            = 0x3             = 64KB/16KB/4KB
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE    (0x3) /* Generated value. Do not edit this manually */
...
/* LPT (Low Power Timer) Clock source select (LPTCR1.LPCNTCKSEL)
   ...
   1 = IWDT
   2 = LPT non use
   3 = Low Speed On-Chip Oscillator (LOCO) clock divided by 4
*/
...
/* Sub-Clock Oscillator Drive Capacity Control (SODRV).
...
/* Clock configuration options.
   ...
   ICLK is 48MHz, PCLKB is 32MHz, FCLK is 48MHz, PCLKD is 48MHz then the 
   settings would be:

   BSP_CFG_XTAL_HZ  = 8000000
   BSP_CFG_PLL_DIV  = 1       (no division)
   BSP_CFG_PLL_MUL  = 6       (8MHz x 6 = 48MHz)
...
/* PLL Frequency Multiplication Factor Select (STC).
   Available multipliers = x4, x4.5, x5, x5.5, x6, x6.5, x7, x7.5, x8, x8.5, x9, x9.5, x10, x10.5, x11, x11.5, x12
*/
#define BSP_CFG_PLL_MUL                 (6) /* Generated value. Do not edit this manually */
...
/* Flash IF Clock Divider (FCK).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_FCK_DIV                 (1) /* Generated value. Do not edit this manually */
...
/* Main Clock Oscillator Wait Time (MOSCWTCR).
   ...
   00000b: Wait time = 0 cycles (0 us)
   ...
   01000b: Wait time =131072 cycles (32.768 ms)
...
*/
#define BSP_CFG_OFS1_REG_VALUE  (0xFFFFDFFF) /* Generated value. Do not edit this manually */
