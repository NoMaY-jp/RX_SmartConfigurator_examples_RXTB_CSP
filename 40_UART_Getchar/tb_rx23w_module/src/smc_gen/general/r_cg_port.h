...
#define _57_PDR0_DEFAULT        (0x57U) /* PDR0 default value */
#define _03_PDR1_DEFAULT        (0x03U) /* PDR1 default value */
#define _18_PDR2_DEFAULT        (0x18U) /* PDR2 default value */
#define _54_PDRB_DEFAULT        (0x54U) /* PDRB default value */
#define _02_PDRC_DEFAULT        (0x02U) /* PDRC default value */
#define _F7_PDRD_DEFAULT        (0xF7U) /* PDRD default value */
#define _E0_PDRE_DEFAULT        (0xE0U) /* PDRE default value */
...
#define _0C_PMR1_MASK           (0x0CU)
#define _01_PMR2_MASK           (0x01U)
#define _1C_PMR3_MASK           (0x1CU)
#define _0C_PDR1_MASK           (0x0CU)
#define _01_PDR2_MASK           (0x01U)
#define _1C_PDR3_MASK           (0x1CU)
#define _0C_PODR1_MASK          (0x0CU)
#define _01_PODR2_MASK          (0x01U)
#define _1C_PODR3_MASK          (0x1CU)
