...
*         : 23.07.2019 1.01    Modified comments of the following macro definition.
*                               - BSP_CFG_RTOS_USED : The value '1'(FreeRTOS is used.) is available.
*                              Added the following macro definition.
*                               - BSP_CFG_RTOS_SYSTEM_TIMER
*         : 26.07.2019 1.01    Added the following macro definition.
*                               - BSP_CFG_VBATT_ENABLE
*         : 08.10.2019 1.02    Added the following macro definition.
...
#define BSP_CFG_MCU_PART_PACKAGE        (0xF) /* Generated value. Do not edit this manually */
...
/* Chip version.
   ...
   D            = 0xD             = Chip version D
                                  = Security function included.
*/
#define BSP_CFG_MCU_PART_VERSION        (0xC) /* Generated value. Do not edit this manually */
...
/* The input clock frequency is specified and then the system clocks are set by specifying the multipliers used. The
   ...
   ICLK is 54MHz, PCLKA is 54MHz, PCLKB is 27MHz, FCLK is 27MHz, and PCLKD is 54MHz then the settings would be:
   ...
   BSP_CFG_PCKD_DIV = 1      : Peripheral Clock D (PCLKD) = 
                               (((BSP_CFG_XTAL_HZ/BSP_CFG_PLL_DIV) * BSP_CFG_PLL_MUL) / BSP_CFG_PCKB_DIV) = 54MHz
...
/* Configure whether voltage detection 0 circuit and HOCO are enabled after reset.
   ...
   b1:b0  VDSEL - Voltage Detection 0 Level Select (1=2.82V, 2=2.51V, 3=1.90V)
...
/* Select the clock to be input to the EXTAL pin according to the board.
   0 = Resonator or External oscillator. (default)
   1 = CLKOUT_RF. (CLKOUT_RF is one of the RX23W output signals.)
*/
#define BSP_CFG_CLKOUT_RF_MAIN                      (0)
